...
import 'package:halo/widget/extended_image/src/image/extended_render_image.dart';
...
class ExtendedRawImage extends LeafRenderObjectWidget {
  ...
  @override
  void updateRenderObject(BuildContext context, ExtendedRenderImage renderObject) {
    renderObject
      ..image = image
      ..width = width
      ..height = height
